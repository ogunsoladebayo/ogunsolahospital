...
$prefix = 'Ogunsola'; // Change this to the name of your business or app
$overrideRef = false;
...
class myEventHandler implements EventHandlerInterface{
    ...
    function onTimeout($transactionReference, $data){
        ...
        if($_SESSION['publicKey']){
            ...
            // $confirmtrans = array(
            //     'TransactionRef' => $transactionReference->txref
            // );
            $confirmtrans = array(
                'TransactionRef' => $transactionReference
            );
            file_put_contents("transactionData/thistransaction" . $_COOKIE['email'] . ".json", json_encode($confirmtrans));
            session_destroy();
        }
    }
}
